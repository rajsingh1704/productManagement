        ...
        return this.each(function () {
            ...
            var fileDivContent = `
                <label for="${fileUploadId}" class="file-upload">
                    ...
                    <input type="file" id="${fileUploadId}" name=productImage[] multiple hidden />
                </label>
            `;
                    ...
                    $.each(files, function (index, file) {
                        ...
                        tableBody.append(`
                            <tr>
                                ...
                                <td>${fileSize}</td>
                                <td>${fileType}</td>
                                <td><button type="button" class="deleteBtn"><i class="fas fa-trash-alt bg-light" style="font-size:20px;color:red;"></i></button></td>
                            </tr>
                        `);
                    });
